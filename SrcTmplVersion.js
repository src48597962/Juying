var newVersion = {
    ...
    "SrcJuyingdesc":{
        ...
        "7.8":"1.替换360分类js文件；2.解析逻辑优化；3.云盘微改；"
    },
    "SrcJu":"2.1",
    "SrcJudesc":{
        "1.0":"聚阅发布",
        ...
        "2.2":"1.界面类型按钮增加快速选择源接口；2.修复搜索分组一直存在的bug；3.二级选集公共传参改为子页面动态取；4.暂时停用程序代理聚合搜索；5.二级封面简介等取值优化；6.增加线路动态解析选集列表等方法；7.换源长按增加是否精准搜索；"
    }
};
