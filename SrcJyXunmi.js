        ...
        function playlist(lx, len) {//定义选集列表生成
            if (lx == '1') {
                ...
                d.push({
                    ...
                    url: playurl + DTJX,
                    extra: { id: playurl, referer: playurl, jsLoadingInject: true, cacheM3u8: getMyVar('superwebM3U8')==1?true:false, blockRules: ['.m4a','.mp3','.mp4','.flv','.avi','.mpeg','.wmv','.mov','.rmvb','.gif','.jpeg','.jpg','.ico','.png','hm.baidu.com','/ads/*.js','cnzz.com'] },
