        ...
        function playlist(lx, len) {//定义选集列表生成
            if (lx == '1') {
                ...
                d.push({
                    ...
                    url: playurl + DTJX,
                    extra: { id: playurl, referer: playurl, ua: PC_UA, jsLoadingInject: true, blockRules: ['.m4a','.mp3','.mp4','.flv','.avi','.mpeg','.wmv','.mov','.rmvb','.gif','.jpg','.jpeg','.png','.ico','.svg','hm.baidu.com','/ads/*.js','cnzz.com','.css'] },
